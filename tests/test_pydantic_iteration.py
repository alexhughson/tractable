...
def test_iterate_with_pydantic_model():
    ...
    users = []
    for user in spreadsheet.range("Sheet1!A1:C4").iter(User):
        users.append(user)
...
def test_iterate_with_pydantic_model_defaults():
    service_account_dict = get_test_credentials()
    sheet_id = get_test_sheet_id()
    ...
    users = []
    for user in spreadsheet.range("Sheet1!A1:D4").iter(UserWithDefaults):
        users.append(user)
...
def test_iterate_with_pydantic_model_optional_fields():
    service_account_dict = get_test_credentials()
    sheet_id = get_test_sheet_id()
    ...
    users = []
    for user in spreadsheet.range("Sheet1!A1:D4").iter(UserWithOptional):
        users.append(user)
...
def test_iterate_unbounded_range_with_pydantic():
    service_account_dict = get_test_credentials()
    sheet_id = get_test_sheet_id()
    ...
    worksheet.update(test_data, "A1:C5")
    
    spreadsheet = Spreadsheet(service_account_dict, sheet_id)
    
    users = []
    for user in spreadsheet.range("Sheet1!A:C").iter(User):
        users.append(user)
...
def test_iterate_with_pydantic_model_extras():
    service_account_dict = get_test_credentials()
    sheet_id = get_test_sheet_id()
    ...
    users = []
    for user in spreadsheet.range("Sheet1!A1:E4").iter(UserWithExtras):
        users.append(user)
